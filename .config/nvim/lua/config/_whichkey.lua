...
local mappings = {
	...
	c = {
		...
		o = { "<cmd>lua require('custom.functions').organize_imports()<CR>", "Organize imports" },
	...
	w = {
		...
		S = { "<cmd>WindowsMaximizeVertically<CR>", "maximize vertically" },
		s = { "<C-w>s", "split horizontal" },
		V = { "<cmd>WindowsMaximizeHorizontally<CR>", "maximize horizontally" },
