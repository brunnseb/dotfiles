...
keymap("n", "gs/", "<cmd>HopPattern<CR>", silent)
...
keymap("n", "<Leader>wl", "<C-w>l", silent)
keymap("n", "<Leader>wj", "<C-w>j", silent)
keymap("n", "<Leader>wk", "<C-w>k", silent)
keymap("n", "<Leader>wc", "<C-w>q", silent)
keymap("n", "<Leader>wv", "<C-w>v", silent)
keymap("n", "<Leader>ws", "<C-w>s", silent)
keymap("n", "<Leader>wo", "<C-w>|", silent)
keymap("n", "<Leader>w=", "<C-w>=", silent)
