...
_G.packer_plugins = {
  ...
  ["lua-dev.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/brunnseb/.local/share/nvim/site/pack/packer/opt/lua-dev.nvim",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp-signature-help", "cmp-nvim-lua", "cmp-path", "cmp-treesitter", "cmp_luasnip", "LuaSnip", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "friendly-snippets" },
  ...
  ["nvim-lsp-installer"] = {
    ...
    loaded = false,
    needs_bufread = true,
    path = "/home/brunnseb/.local/share/nvim/site/pack/packer/opt/nvim-lsp-installer",
  ...
  ["nvim-lspconfig"] = {
    after = { "nvim-lsp-installer", "lua-dev.nvim", "vim-illuminate" },
    config = { "\27LJ\2\n8\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\nsetup\15config.lsp\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/home/brunnseb/.local/share/nvim/site/pack/packer/opt/nvim-lspconfig",
  ...
  ["nvim-treesitter"] = {
    after = { "lualine.nvim", "logsitter.nvim" },
    loaded = true,
    only_config = true
  },
  ...
  ["vim-illuminate"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/brunnseb/.local/share/nvim/site/pack/packer/opt/vim-illuminate",
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-lspconfig', 'nvim-bufferline.lua', 'trouble.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'lualine.nvim', 'which-key.nvim', 'lspsaga.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
