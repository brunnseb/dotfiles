...
config = {
	...
	font = wezterm.font_with_fallback({ { family = "MonoLisa", weight = "Regular" }, "Symbola" }),
	line_height = 1.1,
	inactive_pane_hsb = {
		saturation = 0.8,
		brightness = 0.7,
	...
	keys = {
		...
		{ key = "UpArrow", mods = "SHIFT|CTRL|ALT", action = act.ScrollByPage(-1) },
		{ key = "DownArrow", mods = "SHIFT|CTRL|ALT", action = act.ScrollByPage(1) },
	},
}
